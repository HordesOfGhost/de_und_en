...
from .prompt import prompt_for_generating_reading_content
from sqlalchemy.orm import Session
from .utils import extract_json_content_from_llm_response

def generate_reading_content(level: str):
    prompt = prompt_for_generating_reading_content.format(level=level)
